...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and compete against other schools",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["aaron@mergington.edu", "lina@mergington.edu"]
    },
    "Swim Club": {
        "description": "Build swimming skills and endurance with guided practice",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "eric@mergington.edu"]
    },
    "Art Workshop": {
